            ...
            <Navbar expand="lg" className="navbar navbar-dark bg-dark">
                <Container>
                    ...
                    <Nav className="me-auto">
                        <Nav.Link onClick={currentUser ? navigate('/') : navigate('/logout')}>Home</Nav.Link>
                        <Nav.Link onClick={currentUser ? navigate('/update-profile') : navigate('/logout')}>Profile</Nav.Link>
                    </Nav>
                </Container>
            </Navbar>
